...
// TODO: Part 4b
std::string vertShade = ShaderAsString("/VertexShader.hlsl");
std::string pixShade = ShaderAsString("/PixelShader.hlsl");
const char* vertexShaderSource2 = vertShade.c_str();
const char* pixelShaderSource2 = pixShade.c_str();
