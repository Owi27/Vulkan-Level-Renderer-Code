...
public:
	...
	Renderer(GW::SYSTEM::GWindow _win, GW::GRAPHICS::GVulkanSurface _vlk)
	{
		...
		GvkHelper::create_buffer(physicalDevice, device, sizeof(plus),
			VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | 
			VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &vertexHandle, &vertexData);
		GvkHelper::write_to_buffer(device, vertexData, plus, sizeof(plus));
		// TODO: Part 3c
		...
		depth_stencil_create_info.depthTestEnable = VK_TRUE; // TODO: Part 4g
	...
	void Render()
	{
		...
		// TODO: Part 3b
		// TODO: Part 3d
		vkCmdDraw(commandBuffer, 13, 1, 0, 0); // TODO: Part 1b // TODO: Part 4g
		// TODO: Part 4g
	}
private:
	void CleanUp()
